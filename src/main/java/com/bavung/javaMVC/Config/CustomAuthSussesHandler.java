...
public class CustomAuthSussesHandler implements AuthenticationSuccessHandler {

   //@Autowired
    private UserService userService;
    public CustomAuthSussesHandler (UserService userService)
    {
    ...
    // don dep session cũ khi ng dùn login thanh cong
